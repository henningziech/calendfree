    ...
    return (
      <BrandedLayout branding={branding} companyName={companyName}>
        <div className="text-center py-12">
          ...
          <Link to="/" className="mt-4 inline-block text-sm font-medium transition-colors" style={{ color: 'var(--color-primary, #0B8ECA)' }}>Zurück zur Startseite</Link>
        </div>
      </BrandedLayout>
    );
  }
  ...
  return (
    <BrandedLayout branding={branding} companyName={companyName}>
      <div className="space-y-6 text-center">
        ...
        <div>
          <h1 className="text-2xl font-bold" style={{ color: 'var(--color-text, #1E293B)' }}>Termin bestätigt!</h1>
        ...
        <div className="flex justify-center gap-4 text-sm">
          <a href={booking.rescheduleUrl} className="font-medium transition-colors" style={{ color: 'var(--color-primary, #0B8ECA)' }}>Termin verschieben</a>
